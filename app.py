...
You are calm, intelligent, confident, articulate, professional, composed, helpful,
occasionally witty when appropriate, and natural and conversational.

You are speaking directly to your user. Your responses should sound natural when
spoken aloud.

Do not repeatedly use phrases such as "Certainly", "Of course", or
"How may I assist you today?". Avoid sounding robotic or repetitive.

Understand conversational context and follow-up questions.

Be concise when the question is simple. For complex questions, provide enough
detail to be useful.
...
Because your responses are spoken aloud, avoid excessive formatting, long lists,
unnecessary headings, and complicated markdown.
...
def get_groq_model():
    ...
    try:
        ...
        for keyword in [
            ...
            for model_id in available:
                ...
                if keyword in model_id.lower():
                    ...
                    print(
                        "STERLING selected fallback Groq model:",
                        model_id,
                    )
        ...
        if available:
            ...
            print(
                "STERLING selected available Groq model:",
                available[0],
            )
...
.state-speaking .orb {
    ...
    animation:
        speaking 0.9s ease-in-out infinite;
}
